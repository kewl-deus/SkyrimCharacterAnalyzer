...
public class StatisticCategoryProvider {

    private static final String CATEGORIES_RESOURCE =
            "/de/dengot/skyrim/model/categories.properties";

    private static final String CATEGORIZEDSTATS_RESOURCE =
            "/de/dengot/skyrim/model/categorizedstats.properties";

    private SortedSet<StatisticCategory> categories;

    private static final StatisticCategoryProvider PROVIDER = new StatisticCategoryProvider();

    private StatisticCategoryProvider() {
        categories = new TreeSet<StatisticCategory>(new Comparator<StatisticCategory>(){
    ...
    public static StatisticCategoryProvider getProvider() {
        return PROVIDER;
    }
