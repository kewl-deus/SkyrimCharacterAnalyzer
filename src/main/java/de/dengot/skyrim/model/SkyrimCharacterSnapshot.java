...
public class SkyrimCharacterSnapshot {
	...
	public SkyrimCharacterSnapshot(int id, String label, Calendar saveTime, int level, String location,
			List<StatisticValue> stats) {
		super();
		this.id = id;
		this.label = label;
	...
	public SkyrimCharacterSnapshot(int id, String label, Calendar saveTime, int level, String location) {
		...
		this.level = level;
		this.location = location;
		this.stats = new ArrayList<StatisticValue>();
	}
